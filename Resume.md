...
##### **某ファンクラブの会員統合及び基幹システムの刷新 (2025 年 9 月〜2026 年 3 月)**

- **役割:** テックリード
- **業務内容:**
  - 現行システムの調査・分析によるリプレイス要件の整理
  - 基幹システム（共通基盤）アーキテクチャの設計・提案および認証基盤の統一の設計・提案
  - オフショア開発（ベトナムチーム）への技術支援（技術的 Q&A 対応、設計ドキュメント・仕様書の整備、開発推進のためのサポート）
  - 技術的課題の実証実験と導入支援
- **利用技術:** Amazon Cognito, Amazon DMS


##### **化粧品検索プロダクトのフルリプレイス (2025 年 8 月〜)**
...
##### **リスティング広告の分析・提案自動化 (2025 年 6 月〜)**

- **役割:** リーダー, エンジニア
- **業務内容:**
  - n8n と複数の Web API・LLM を用いたリスティング広告の提案書自動作成ワークフローの実装
- **利用技術:** n8n, JavaScript
