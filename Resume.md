...
エンジニアとしてのスキルだけでなく、ビジネスの視点も持ち合わせており、プロダクト開発においては常にビジネス要求を技術的にどう実現するかを考え、部門の垣根を越えて貢献することを心掛けています 。
...
| Framework          | Nuxt.js                    | 2025 年 1 月～  | フロントエンド SaaS 等                         |
...
| その他ミドルウェア | Metabase                    | 2019 年 4 月～ | 分析サービス等                                 |
...
##### **アーティストファンクラブのシステム統合 (2025 年 9 月〜2026 年 3 月)**

- **役割:** テックリード
- **業務内容:**
  - 現行システムの調査・分析によるリプレイス要件の整理
  - 基幹システム（共通基盤）アーキテクチャの設計・提案および認証基盤の統一の設計・提案
  - オフショア開発（ベトナムチーム）への技術支援（技術的 Q&A 対応、設計ドキュメント・仕様書の整備、開発推進のためのサポート）, ファシリテーション
  - 技術的課題の実証実験と導入支援
- **利用技術:** Amazon Cognito, Amazon DMS


##### **化粧品等の雑誌露出調査プロダクトのフルリプレイス (2025 年 8 月〜)**
...
- **業務内容:**
  ...
  - 現行システムの調査・分析によるリプレイス要件の整理
  - 技術的課題の実証検証
  - 新アーキテクチャの設計およびシステム開発
  - AWS App Runner / ECS を用いた開発・本番環境の構築
  - Claude Codeを用いたAI駆動開発の推進と改善
- **利用技術:** Bun, Nuxt4, AWS App Runner, Amazon ECS, AWS SAM, AWS Lambda, Playwright

##### **SEO対策に向けたサイト分析基盤の構築 (2025 年 8 月〜)**

- **役割:** リーダー, フルスタックエンジニア
- **業務内容:**
  - Google Search Console, Google Analytics 4, Ahrefs 等の複数データソースを統合した BigQuery 上のサイト分析基盤の設計・実装・運用・改善
  - BigQuery およびスプレッドシートを活用したデータの可視化・分析
- **利用技術:** BigQuery, GCS, Google スプレッドシート

##### **リスティング広告の分析・提案自動化 (2025 年 6 月〜 2026 年 3月)**

- **役割:** リーダー, エンジニア
- **業務内容:**
  - n8nを用いて、SEO系APIツールの連携・Gemini API を用いたリスティング広告の提案書自動作成ワークフローの実装
- **利用技術:** n8n, JavaScript, Gemini API

##### **営業改善ツールの作成 (2025 年 2 月〜2025 年 4月)**

- **役割:** リーダー
- **業務内容:**
  - 営業活動の工数削減を目的にしたツールの実装、運用、改善
- **利用技術:** Node.js, TypeScript, Electron, Vue, Prisma

##### **Windows アプリの開発 (OCR、翻訳) (2025 年 4 月〜2025 年 5 月)**

- **役割:** リーダー, フルスタックエンジニア
- **業務内容:**
  - C# を用いた Windows アプリの開発
- **利用技術:** C#
